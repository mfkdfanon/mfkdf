...
- [MFKDF Library](https://github.com/mfkdfanon/mfkdf/tree/main/MFKDF)
- [Centralized Demo](https://github.com/mfkdfanon/mfkdf/tree/main/centralized-demo)
- [Decentralized Demo](https://github.com/mfkdfanon/mfkdf/tree/main/decentralized-demo)
- [Benchmarking](https://github.com/mfkdfanon/mfkdf/tree/main/benchmarking)
...
- MFKDFDerivedKey.setThreshold
- MFKDFDerivedKey.removeFactor
- MFKDFDerivedKey.removeFactors
- MFKDFDerivedKey.addFactor
- MFKDFDerivedKey.addFactors
- MFKDFDerivedKey.recoverFactor
- MFKDFDerivedKey.recoverFactors
- MFKDFDerivedKey.reconstitute
...
## Enveloped Keys
Sometimes, the secret you wish to envelop using a multi-factor derived key is itself a cryptographic key, such as an RSA private key. You can use MFKDFDerivedKey.addEnvelopedKey and MFKDFDerivedKey.getEnvelopedKey for this purpose:
...
For more information on any of the functions described above, please view the MFKDF website and documentation. (The links have been removed because they are not anonymous.)
